    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial -->
        ...
        <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Update<?=$event['name']?></h4>
                  <p class="card-description">
                    Roban admin
                  </p>
                  <form class="forms-sample" method="POST" action="eventlist.php?update=<?=$event['id']?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="<?=$event['place']?>" class="form-control" name="place" placeholder="Event place"  required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="capacity" min="50" placeholder="Capacity" value="<?=$event['capacity']?>" required>
                    </div>
