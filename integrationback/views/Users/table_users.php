  ...
  <div class="container-scroller">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold">Ayoub</span></h1>
            <h3 class="welcome-sub-text">Your performance summary this week </h3>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown d-none d-lg-block">
            <a class="nav-link dropdown-bordered dropdown-toggle dropdown-toggle-split" id="messageDropdown" href="assets/#" data-bs-toggle="dropdown" aria-expanded="false"> Select Category </a>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator" id="notificationDropdown" href="assets/#" data-bs-toggle="dropdown">
          ...
          <li class="nav-item dropdown"> 
            <a class="nav-link count-indicator" id="countDropdown" href="assets/#" data-bs-toggle="dropdown" aria-expanded="false">
              <i class="icon-bell"></i>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="assets/#tables" aria-expanded="false" aria-controls="tables">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="assets/pages/tables/basic-table.html">Users list</a></li>
                <li class="nav-item"> <a class="nav-link" href="../formation/template/formationlist.php">course list</a></li>
                <li class="nav-item"> <a class="nav-link" href="../events/template/eventlist.php">events list</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="assets/#auth" aria-expanded="false" aria-controls="auth">
      ...
      <div class="main-panel">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
					                    <a href="delete.php?CIN=<?php echo $user['CIN']; ?>">Supprimer</a>
			                  	</td>
			                  </tr> 
                        <?php
			                  	}
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Premium <a href="assets/https://www.bootstrapdash.com/" target="_blank">Bootstrap admin template</a> from BootstrapDash.</span>
