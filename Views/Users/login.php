...
<body>
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
			...
			<section class="full-height relative no-top no-bottom vertical-center" data-bgimage="url(../assets/images/background/subheader.jpg) top" data-stellar-background-ratio=".5">
					...
					<div class="center-y relative">
						<div class="container">
							<div class="row align-items-center">
                                ...
                                <p class="lead">It's fun to work the robotic arm in part because it's really a team effort.</p>
                            </div>
								...
								<div class="col-lg-4 offset-lg-1 wow fadeIn" data-wow-delay=".5s">
									<div class="box-rounded padding40" data-bgcolor="#ffffff">
										...
										<form name="loginform"  class="form-border" method="post" action='login_form.php'>
											...
											<div class="field-set">
												<input type='submit'  value='connect' class="btn btn-main btn-fullwidth color-2">
											</div>
