            ...
            <section aria-label="section">
                <div class="container">
                        ...
                        <div class="col-lg-8 mb-sm-30">
							...
							<form name="contactForm" id="contact_form" class="form-border" method="post"    action="modif_reclamation.php=<?php echo $reclamationC['idreclamation']; ?>">
								<div class="field-set">
									<textarea name="reclamation"  id="reclamation" class="form-control" placeholder=" reclamation"></textarea>
								</div>	
